...
class Pelt:
    ...
    monochrome_colours: list = []
    natural_colours: list = []
    fall_colours: list = []
    summer_colours: list = []
    winter_colours: list = []
    spring_colours: list = []
    ...
    for sprite_list in sprites.PELT_DATA["sprite_list"]:
        ...
        for colour in sprite_list:
            if sprite_list[colour] == "monochrome":
                monochrome_colours.append(colour)
            elif sprite_list[colour] == "natural":
                natural_colours.append(colour)
            elif sprite_list[colour] == "fall":
                fall_colours.append(colour)
            elif sprite_list[colour] == "summer":
                summer_colours.append(colour)
            elif sprite_list[colour] == "winter":
                winter_colours.append(colour)
            elif sprite_list[colour] == "spring":
                spring_colours.append(colour)
    ...
    for sprite_list in sprites.EYE_DATA["sprite_list"]:
        ...
        for colour in sprite_list:
            if sprite_list[colour] == "ancestral":
                ancestral_eyes.append(colour)
            elif sprite_list[colour] == "floral":
                floral_eyes.append(colour)
            elif sprite_list[colour] == "aerial":
                aerial_eyes.append(colour)
            elif sprite_list[colour] == "aquatic":
                aquatic_eyes.append(colour)
            elif sprite_list[colour] == "arid":
                arid_eyes.append(colour)
    ...
    def init_eyes(self, parents):
        ...
        if not parents:
            ...
            self.eye_colour = choice(
                [i.pelt.eye_colour for i in parents] + [choice(Pelt.ancestral_eyes + Pelt.floral_eyes + Pelt.aerial_eyes + Pelt.aquatic_eyes + Pelt.arid_eyes)]
            )
