...
class ProfileScreen(Screens):
    ...
    def handle_event(self, event):
        if event.type == pygame_gui.UI_BUTTON_START_PRESS:
            if event.ui_element == self.back_button:
                ...
                self.close_current_tab()
                self.change_screen("customize cat screen") # merge of the Cat Customizer Mod by prettyflyfora
    ...
    def screen_switches(self):
        ...
        self.customize_cat_button = UISurfaceImageButton(
            ...
            object_id="@buttonstyles_squoval",
            manager=MANAGER,
        ) # merge of the Cat Customizer Mod by prettyflyfora
    ...
    def exit_screen(self):
        ...
        self.customize_cat_button.kill() # merge of the Cat Customizer Mod by prettyflyfora
        self.close_current_tab()
